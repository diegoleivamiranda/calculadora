...
var textLevelRequired = "Nivel necesario:";
var textPointsLeft = "Puntos restantes:";
var textPointsSpent = "Puntos gastados:";
var textPoint = "punto";
var textPoints = "puntos";
var textColon = ":";
var textLeftClick = "Click Izquierdo para aprender"
var textRightClick = "Click Derecho para olvidar"
var textRankColon = "Rango:"
var textToSave = "Para guardar la plantilla y consultarla más adelante, copie la siguiente URL:";
var textNextRank = "Proximo rango:";
var requiresRequires = "Requiere";
...
function getStringRequires(requirementPoints, requirementName) {
	...
	if (requirementPoints == 1)
		theS = "";
	var theString = 'Requiere '+ requirementPoints +' punto'+ theS +' in '+ requirementName;
	return theString;
}

function getStringRequiresTalents(requirementPoints, requirementName) {
	var theString = 'Requiere '+ requirementPoints +' puntos en '+ requirementName +' Talentos';
	return theString
}
