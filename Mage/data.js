...
talent[i] = [0, "Sutileza Arcana", 2, 1, 1]; i++;
talent[i] = [0, "Enfoque Arcano", 3, 2, 1]; i++;
talent[i] = [0, "Estabilidad Arcana", 5, 3, 1]; i++;
talent[i] = [0, "Entereza Arcana", 3, 1, 2]; i++;
talent[i] = [0, "Amortiguación Mágica", 2, 2, 2]; i++;
talent[i] = [0, "Concentración Arcana", 5, 3, 2]; i++;
talent[i] = [0, "Armonización Mágica", 2, 1, 3]; i++;
talent[i] = [0, "Impacto del Hechizo", 3, 2, 3]; i++;
talent[i] = [0, "Estudiante de la Mente", 3, 3, 3]; i++;
talent[i] = [0, "Enfocar Magia", 1, 4, 3]; i++;
talent[i] = [0, "Protección Arcana", 2, 1, 4]; i++;
talent[i] = [0, "Contrahechizo Mejorado", 2, 2, 4]; i++;
talent[i] = [0, "Meditación Arcana", 3, 3, 4]; i++;
talent[i] = [0, "Torturar a los débiles", 3, 4, 4]; i++;
talent[i] = [0, "Traslación mejorada", 2, 1, 5]; i++;
talent[i] = [0, "Presencia mental", 1, 2, 5]; i++;
talent[i] = [0, "Mente arcana", 5, 4, 5]; i++;
talent[i] = [0, "Capa centelleante", 3, 1, 6]; i++;
talent[i] = [0, "Inestabilidad arcana", 3, 2, 6, [getTalentID("Presencia mental"),1]]; i++;
talent[i] = [0, "Potencia Arcana", 2, 3, 6, [getTalentID("Presencia mental"),1]]; i++;
talent[i] = [0, "Potenciación Arcana", 3, 1, 7]; i++;
talent[i] = [0, "Poder Arcano", 1, 2, 7, [getTalentID("Inestabilidad arcana"),3]]; i++;
talent[i] = [0, "Absorción de encantador", 3, 3, 7]; i++;
talent[i] = [0, "Corrientes Arcanas", 2, 2, 8, [getTalentID("Poder Arcano"),1]]; i++;
talent[i] = [0, "Maestria mental", 5, 3, 8]; i++;
talent[i] = [0, "Relentizar", 1, 2, 9]; i++;
talent[i] = [0, "Tromba de misiles", 5, 3, 9]; i++;
talent[i] = [0, "Presencia viento abisal", 3, 2, 10]; i++;
talent[i] = [0, "Poder con hechizos", 2, 3, 10]; i++;
talent[i] = [0, "Tromba Arcana", 1, 2, 11]; i++;
treeStartStop[t] = i -1;
t++;

//fire talents
talent[i] = [1, "Explosión de fuego Mejorada", 2, 1, 1]; i++;
talent[i] = [1, "Incineración", 3, 2, 1]; i++;
talent[i] = [1, "Bola de fuego Mejorada", 5, 3, 1]; i++;
talent[i] = [1, "Ignición", 5, 1, 2]; i++;
talent[i] = [1, "Determinación ardiente", 2, 2, 2]; i++;
talent[i] = [1, "Mundo en llamas", 3, 3, 2]; i++;
talent[i] = [1, "Lanzar llamas", 2, 1, 3]; i++;
talent[i] = [1, "Impacto", 3, 2, 3]; i++;
talent[i] = [1, "Piroexplosión", 1, 3, 3]; i++;
talent[i] = [1, "Alma ardiente", 2, 4, 3]; i++;
talent[i] = [1, "Agostar mejorado", 3, 1, 4]; i++;
talent[i] = [1, "Escudos de arrabio", 2, 2, 4]; i++;
talent[i] = [1, "Maestro de los elementos", 3, 4, 4]; i++;
talent[i] = [1, "Jugando con fuego", 3, 1, 5]; i++;
talent[i] = [1, "Masa crítica", 3, 2, 5]; i++;
talent[i] = [1, "Ola explosiva", 1, 3, 5, [getTalentID("Piroexplosión"),1]]; i++;
talent[i] = [1, "Velocidad llameante", 2, 1, 6]; i++;
talent[i] = [1, "Poder de fuego", 5, 3, 6]; i++;
talent[i] = [1, "Piromano", 3, 1, 7]; i++;
talent[i] = [1, "Combustión", 1, 2, 7, [getTalentID("Masa crítica"),3]]; i++;
talent[i] = [1, "Furia de arrabio", 2, 3, 7]; i++;
talent[i] = [1, "Restitución Ignea", 2, 1, 8]; i++;
talent[i] = [1, "Fuego Potenciado", 3, 3, 8]; i++;
talent[i] = [1, "Aceleración de ignición", 2, 1, 9, [i+1,1]]; i++;
talent[i] = [1, "Aliento de dragón", 1, 2, 9, [getTalentID("Combustión"),1]]; i++;
talent[i] = [1, "Buena racha", 3, 3, 9]; i++;
talent[i] = [1, "Consunción", 5, 2, 10]; i++;
talent[i] = [1, "Bomba viviente", 1, 2, 11]; i++;
...
rank[i] = [
"Reduce la probabilidad que disipen tus hechizos de ayuda y efectos de daño en el tiempo un 15% y reduce la cantidad de amenaza causada por tus hechizos Arcanos 20%.",
"Reduce la probabilidad que disipen tus hechizos de ayuda y efectos de daño en el tiempo un 30% y reduce la cantidad de amenaza causada por tus hechizos Arcanos 40%."
		];
i++;		
